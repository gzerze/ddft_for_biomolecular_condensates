...
#SBATCH --output=/project/zerze/morganmurray/software/RPA_ddft3_2/log/ddft_analysis_%j.out
...
jobname=ParaEx_FH_Es_-0p07_Eh_-0p3
module purge
...
mpirun -np 1 python  scripts/DDFT/RPA_ddft.py --i ${main_dir}/scripts/DDFT/input_params.txt --o ${main_dir}/Results/$jobname/  --s ${main_dir}/Results/$jobname/
